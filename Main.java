public class Main {
    public static void main(String[] args) {
        ...
        Torneo t = new Torneo(
                ...
                CapturaDeE.capturarString("Nombre del torneo"),
                CapturaDeE.capturarString("Region"),
                CapturaDeE.capturarEntero("Cantidad de equipos participantes"),
                CapturaDeE.capturarEntero("Cantidad de partidos jugados"),
                CapturaDeE.capturarEntero("Cantidad de partidos por jugar"));
